 ...
 * @author Daisy N
 */
public class ParticularAttendance extends JPanel {
 ...
 String query ="select checkin.EmpId,checkin.checkinDate,checkin.checkinTime,checkout.checkOutTime from checkin,checkout where checkin.EmpId=checkout.EmpId and checkout.EmpId='"+LoginPage.jTextField1.getText()+"'";
