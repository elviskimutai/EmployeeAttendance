 ...
 * @author Daisy N
 */
public class StaffSpecificAttendance extends JPanel {
    ...
    public StaffSpecificAttendance() {
...
String query ="select distinct checkin.EmpId,checkin.checkinDate,checkin.checkinTime,checkout.checkOutTime from checkin,checkout where checkin.EmpId=checkout.EmpId and checkin.EmpId='"+LoginPage.jTextField1.getText()+"'";
