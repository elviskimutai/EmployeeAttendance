 ...
 * @author Daisy N
 */
public class AllSpecificAttendance extends JPanel {
...
String query ="select * from checkin where EmpId='"+userAttendance.jTextField1.getText()+"'";
