 ...
 * @author Daisy N
 */
public class AllAttendance extends JPanel {
...
String query ="select checkin.EmpId,checkin.checkinDate,checkin.checkinTime,checkout.checkOutTime from checkin,checkout where checkin.EmpId=checkout.EmpId";
